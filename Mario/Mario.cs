...
namespace Mario
{
    internal class Mario
    {
        ...
        public void render(FrameEventArgs args, Camera _camera, KeyboardState input, int x, int y)
        {
            ...
            {
                List<float> _verticesTemp = objectList[0].createCurveBezier(0.595f);
            ...
            {
                List<float> _verticesTemp = objectList[2].createCurveBezier(0.595f);
